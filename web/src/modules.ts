...
> = {
  body: {
    ...
    features: [
      ...
      { feature: "整床升降", match: ["床高", "整床", "把床", "升降", "床身", "床调", "床降", "床升", "降床", "升床", "床太高", "床太低", "下床", "上床"], action: "已调整床身高度", component: "床体升降机构", state: "床高调好了" },
  ...
  relationship: {
    ...
    idleState: "暂无新留言",
    features: [
      { feature: "留言回顾", match: ["上次", "之前", "刚才", "上一条", "什么留言", "留了什么", "留言了什么", "留过", "念一下", "回顾"], action: "已为您找到留言", component: "家人留言箱", state: "念了上一条留言" },
