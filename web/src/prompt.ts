...
- 应急信号（摔倒、喘不过气、剧痛、自伤、轻生，或护理者/家人代述“他摔了、她喘不上气”等）一律归入 care，intent=“应急呼叫”，confidence 高。
...
- 以下明确不在本演示能力内，一律 unknown、confidence 给低分、reply 温和请对方换个说法或找人工：医疗诊断与用药剂量调整；开关灯/空调/窗帘等家电控制；购物点餐、缴费、查快递；算术、实时新闻或百科细节。
